...
const createCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newCategory = yield productCategory_1.default.create(req.body);
...
const updateCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const category = yield productCategory_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
        });
...
const getAllCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let category;
        if (title !== "" && title) {
            category = yield productCategory_1.default.find({
...
const getCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, validateId_1.validateMongoDbId)(id);
    try {
        const category = yield productCategory_1.default.findById(id);
        res.status(200).json(category);
    }
    catch (err) {
        next(err);
...
const deleteCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, validateId_1.validateMongoDbId)(id);
    try {
        yield productCategory_1.default.findByIdAndDelete(id);
